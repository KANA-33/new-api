...
import { getCurrencyLabel, isCurrencyDisplayEnabled } from '@shared/lib/currency'
import { formatNumber, formatQuota } from '@shared/lib/format'
import { computeTimeRange } from '@shared/lib/time'
import { cn } from '@shared/lib/utils'
import { useStatus } from '@shared/hooks/use-status'
import { Button } from '@shared/ui/primitives/button'
import { StaggerContainer, StaggerItem } from '@widgets/page-transition/page-transition'
import { getUserQuotaDates } from '@domains/observability/dashboard/api'
import { useSummaryCardsConfig } from '@domains/observability/dashboard/hooks/use-dashboard-config'
import type { QuotaDataItem } from '@domains/observability/dashboard/types'
