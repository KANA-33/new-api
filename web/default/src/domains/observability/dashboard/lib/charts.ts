...
import { getCurrencyDisplay } from '@shared/lib/currency'
import { formatChartTime, type TimeGranularity } from '@shared/lib/time'
import { MAX_CHART_TREND_POINTS } from '@domains/observability/dashboard/constants'
import type {
  QuotaDataItem,
  ProcessedChartData,
