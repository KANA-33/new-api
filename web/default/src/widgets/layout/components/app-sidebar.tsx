...
import { MOTION_TRANSITION, MOTION_VARIANTS } from '@shared/lib/motion'
import { useLayout } from '@app/providers/layout-provider'
import { useSidebarView } from '@shared/hooks/use-sidebar-view'
import { Sidebar, SidebarContent, SidebarRail } from '@shared/ui/primitives/sidebar'
